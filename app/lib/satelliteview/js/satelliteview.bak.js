...
ShinetekView.OpenlayerOpt = {
    ...
    updateCss :function () {
        ...
        //_ol_full_screen_false.style.backgroundImage = "url(publics/full.png)";
        //_ol_full_screen_false.style.backgroundSize = "100% 100%"
    },
     ...
     * @returns {*}
     */
    addLayer: function (nameFun, nameLayer, oURL, isBase, WorT ,photoType , jsonType) {
        //判断不同的图层格式调用不同的加载方式
        if (WorT === "WMS") {
            var layer = new ol.layer.Tile({
                title: nameLayer,
            ...
            return ShinetekView.OpenlayerOpt.addTile(nameFun, nameLayer, oURL, isBase, WorT ,photoType);
        }
        else if (WorT === "KML") {
            //火点的俩种加载方式
            //方法一
                ...
                function pointStyleFunction(feature, resolution) {
                    return new ol.style.Style({
                        image: new ol.style.Circle({
                            ...
                            stroke: new ol.style.Stroke({color: '#06cae5', width: 10})
                        }),
                        stroke: new ol.style.Stroke({
                            color: '#06cae5',
                            width: 4

...
Shinetek.styleCache = {};
Shinetek.map = {};
Shinetek.resolutions = [0.703125, 0.351562, 0.175781, 0.087891, 0.043945, 0.019531, 0.009766, 0.004883, 0.002441];
Shinetek.OpenlayerOpt = {
    ...
    init: function (url) {
        Shinetek.map = new ol.Map({
            ...
            view: new ol.View({
                ...
                resolutions: Shinetek.resolutions,
    ...
    newResolution: function (res) {
        ...
        switch (res) {
            case   Shinetek.resolutions[2]:
            {
                res = "16000M";
                break;
            }
            case  Shinetek.resolutions[3]:
            {
                res = "8000M";
                break;
            }
            case  Shinetek.resolutions[4]:
                res = "4000M";
                break;
            case Shinetek.resolutions[5]:
            {
                res = "2000M";
                break;
            }
            case Shinetek.resolutions[6]:
            {
                res = "1000M";
                break;
            }
            case  Shinetek.resolutions[7]:
            {
                res = "500M";
                break;
            }
            case  Shinetek.resolutions[8]:
            {
                res = "250M";
                break;
            }
